...
exports.idValidator = [param('id').isUUID().withMessage('El ID debe ser un UUID válido')];
...
exports.actualizarLugarAreaValidator = [
  ...
  body('codigo').optional().isString().trim().isLength({ min: 1, max: 50 }),

  body('nombre').optional().isString().trim().isLength({ min: 2, max: 150 }),

  body('tipo').optional().isString().trim().isLength({ min: 2, max: 50 }),
...
exports.crearVehiculoValidator = [
  ...
  body('marca').optional({ nullable: true }).isString().trim().isLength({ max: 80 }),

  body('modelo').optional({ nullable: true }).isString().trim().isLength({ max: 80 }),
  ...
  body('propietario').optional({ nullable: true }).isString().trim().isLength({ max: 150 }),
...
exports.actualizarVehiculoValidator = [
  ...
  body('placa').optional().isString().trim().isLength({ min: 5, max: 20 }),

  body('tipoVehiculo').optional().isString().trim().isLength({ min: 2, max: 50 }),

  body('marca').optional({ nullable: true }).isString().trim().isLength({ max: 80 }),

  body('modelo').optional({ nullable: true }).isString().trim().isLength({ max: 80 }),

  body('capacidadKg').optional({ nullable: true }).isDecimal(),
...
exports.crearCategoriaProductoValidator = [
  ...
  body('requiereLote').optional().isBoolean().withMessage('requiereLote debe ser booleano'),

  body('requiereFechaVencimiento')
    .optional()
    .isBoolean()
    .withMessage('requiereFechaVencimiento debe ser booleano'),

  body('requiereTemperatura')
    .optional()
    .isBoolean()
    .withMessage('requiereTemperatura debe ser booleano'),
...
exports.idCategoriaProductoValidator = [param('id').isUUID().withMessage('ID inválido')];
...
exports.idRecepcionValidator = [
  param('id').isUUID().withMessage('El ID de la recepción no es válido'),
];
...
exports.crearRecepcionValidator = [
  ...
  */
  ...
  body('numeroRecepcion')
    ...
    .isLength({ max: 50 })
    .withMessage('El número de recepción no puede superar los 50 caracteres'),
  ...
  body('tipoRecepcion')
    ...
    .isLength({ max: 50 })
    .withMessage('El tipo de recepción no puede superar los 50 caracteres'),
  ...
  body('horaRecepcion')
    ...
    .withMessage('La hora de recepción no tiene un formato válido'),
  ...
  body('observaciones').optional({ nullable: true }).trim(),

  body('estado').optional().isBoolean().withMessage('El estado debe ser verdadero o falso'),
  ...
  */
  ...
  body('usuarioRecepcionId')
    .optional({ nullable: true })
    .isUUID()
    .withMessage('El usuario de recepción no es válido'),

  body('usuarioVerificacionId')
    .optional({ nullable: true })
    .isUUID()
    .withMessage('El usuario de verificación no es válido'),
  ...
  */
  ...
  body('detalles')
    .optional()
    .isArray()
    .withMessage('Los detalles de la recepción deben ser un arreglo'),
  ...
  body('detalles.*.materiaPrimaId')
    .optional({ nullable: true })
    .isUUID()
    .withMessage('La materia prima del detalle no es válida'),

  body('detalles.*.unidadMedida')
    .notEmpty()
    .withMessage('La unidad de medida del detalle es obligatoria')
    .isLength({ max: 30 })
    .withMessage('La unidad de medida no puede superar los 30 caracteres'),
  ...
  body('detalles.*.cantidadSolicitada')
    .optional({ nullable: true })
    .isDecimal()
    .withMessage('La cantidad solicitada debe ser numérica'),

  body('detalles.*.cantidadRecibida')
    .notEmpty()
    .withMessage('La cantidad recibida es obligatoria')
    .isDecimal()
    .withMessage('La cantidad recibida debe ser numérica'),

  body('detalles.*.fechaVencimiento')
    .optional({ nullable: true })
    .isISO8601()
    .withMessage('La fecha de vencimiento no tiene un formato válido'),

  body('detalles.*.lote')
    .optional({ nullable: true })
    .trim()
    .isLength({ max: 100 })
    .withMessage('El lote del detalle no puede superar los 100 caracteres'),

  body('detalles.*.loteProveedor')
    .optional({ nullable: true })
    .trim()
    .isLength({ max: 100 })
    .withMessage('El lote del proveedor no puede superar los 100 caracteres'),
];
...
exports.actualizarRecepcionValidator = [
  ...
  */
  ...
  body('numeroRecepcion')
    ...
    .trim()
    .notEmpty()
    .withMessage('El número de recepción no puede estar vacío')
    .isLength({ max: 50 })
    .withMessage('El número de recepción no puede superar los 50 caracteres'),
  ...
  body('tipoRecepcion')
    ...
    .trim()
    .notEmpty()
    .withMessage('El tipo de recepción no puede estar vacío')
    .isLength({ max: 50 })
    .withMessage('El tipo de recepción no puede superar los 50 caracteres'),
  ...
  body('proveedorId').optional().isUUID().withMessage('El proveedor no es válido'),
...
exports.idDetalleRecepcionValidator = [
  param('id').isUUID().withMessage('El id del detalle de recepción debe ser un UUID válido'),
];
...
exports.actualizarDetalleRecepcionValidator = [
  body('productoId').optional().isUUID().withMessage('El productoId debe ser un UUID válido'),
  ...
  body('cantidad').optional().isDecimal().withMessage('La cantidad debe ser un número decimal'),
...
exports.idRecepcionVehiculoValidator = [
  param('id').isUUID().withMessage('El id del vehículo de recepción debe ser un UUID válido'),
];
...
exports.crearRecepcionVehiculoValidator = [
  ...
  body('precinto')
    ...
    .trim()
    .isLength({ max: 100 })
    .withMessage('El precinto no puede superar los 100 caracteres'),

  body('guiaTransporte')
    .optional({ nullable: true })
    .trim()
    .isLength({ max: 100 })
    .withMessage('La guía de transporte no puede superar los 100 caracteres'),
  ...
  body('vehiculoConductorOk')
    .optional({ nullable: true })
    .isBoolean()
    .withMessage('vehiculoConductorOk debe ser booleano'),
];

exports.actualizarRecepcionVehiculoValidator = [
  body('vehiculoId').optional().isUUID().withMessage('El vehiculoId debe ser un UUID válido'),
...
exports.crearVerificacionRecepcionValidator = [
  ...
  body('plagas').optional({ nullable: true }).isBoolean().withMessage('plagas debe ser booleano'),
  ...
  body('olor').optional({ nullable: true }).isBoolean().withMessage('olor debe ser booleano'),
];
...
exports.idTemperaturaRecepcionValidator = [
  param('id').isUUID().withMessage('El id de la temperatura de recepción debe ser un UUID válido'),
];
...
exports.crearCondicionAmbientalRecepcionValidator = [
  ...
  body('desinfeccionRealizada')
    .optional({ nullable: true })
    .isBoolean()
    .withMessage('desinfeccionRealizada debe ser booleano'),

  body('productoDesinfeccion')
    .optional({ nullable: true })
    .trim()
    .isLength({ max: 150 })
    .withMessage('El producto de desinfección no puede superar los 150 caracteres'),

  body('concentracionDesinfeccion')
    .optional({ nullable: true })
    .trim()
    .isLength({ max: 50 })
    .withMessage('La concentración de desinfección no puede superar los 50 caracteres'),
...
exports.crearResultadoRecepcionValidator = [
  body('resultado')
    ...
    .isLength({ max: 30 })
    .withMessage('El resultado no puede superar los 30 caracteres'),
  ...
  body('fechaDecision')
    .optional({ nullable: true })
    .isISO8601()
    .withMessage('La fecha de decisión debe ser una fecha válida'),
];
...
exports.idUnidadMedidaValidator = [
  param('id').isUUID().withMessage('El ID de la unidad de medida no es válido'),
];
