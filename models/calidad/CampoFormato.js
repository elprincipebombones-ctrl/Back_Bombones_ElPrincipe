...
module.exports = definir(
  'CampoFormato',
  {
    ...
    esCalculado: { type: DataTypes.BOOLEAN, field: 'es_calculado', defaultValue: false },
    campoNumeradorId: { type: DataTypes.UUID, field: 'campo_numerador_id', allowNull: true },
    campoDenominadorId: { type: DataTypes.UUID, field: 'campo_denominador_id', allowNull: true },
    multiplicador: {
