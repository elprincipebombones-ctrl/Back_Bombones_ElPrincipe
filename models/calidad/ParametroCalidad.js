...
module.exports = definir(
  'ParametroCalidad',
  {
    ...
    esObligatorioDefault: {
      type: DataTypes.BOOLEAN,
      allowNull: false,
      defaultValue: false,
      field: 'es_obligatorio_default',
    },
    permiteObservacionDefault: {
      type: DataTypes.BOOLEAN,
      allowNull: false,
      defaultValue: true,
      field: 'permite_observacion_default',
    },
    requiereEvidenciaDefault: {
      type: DataTypes.BOOLEAN,
      allowNull: false,
      defaultValue: false,
      field: 'requiere_evidencia_default',
    },
    bloquearAlGuardarDefault: {
      type: DataTypes.BOOLEAN,
      allowNull: false,
      defaultValue: false,
      field: 'bloquear_al_guardar_default',
    },
