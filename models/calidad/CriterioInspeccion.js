...
module.exports = definir('CriterioInspeccion', {
  ...
  resultadoEsperado: { type: DataTypes.STRING(50), allowNull: false, defaultValue: 'CUMPLE', field: 'resultado_esperado' },
  permiteObservacion: { type: DataTypes.BOOLEAN, allowNull: false, defaultValue: true, field: 'permite_observacion' },
  requiereEvidencia: { type: DataTypes.BOOLEAN, allowNull: false, defaultValue: false, field: 'requiere_evidencia' },
